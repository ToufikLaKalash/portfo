...
<html>
	...
	<title>Contact - GISSELMANN Olivier</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 text-right menu-1">
                            <ul>
                                ...
                                <li><a class="active" href="projets.php">Projets</a></li>
		...
		<div id="fh5co-contact">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Contactez-moi</h2>
					<p>N'hésitez pas à prendre contact avec moi si vous avez des questions ou si vous souhaitez prendre un rendez-vous.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-md-push-1 animate-box">
					...
					<ul class="contact-info">
						<li><i class="icon-location4"></i>4 Avenue du 8 mai, 13090 Aix-en-Provence</li>
						<li><i class="icon-phone3"></i>07 83 70 64 10</li>
						<li><i class="icon-location3"></i><a href="#">olivier.gisselmann@ynov.com</a></li>
						<li><i class="icon-globe2"></i><a href="#">www.gragoubide.fr</a></li>
					</ul>
				</div>
